...
insert  into `product_currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values (1,'Pound Sterling','GBP','£','','2',0.61250001,1,'2014-09-25 14:40:00'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2018-12-03 14:13:05'),(3,'Euro','EUR','','€','2',0.78460002,1,'2014-09-25 14:40:00');
...
insert  into `product_layout`(`layout_id`,`name`) values (1,'Home'),(2,'Product'),(3,'Category'),(4,'Default'),(5,'Manufacturer'),(6,'Account'),(7,'Checkout'),(8,'Contact'),(9,'Sitemap'),(10,'Affiliate'),(11,'Information'),(12,'Compare'),(13,'Search');
...
insert  into `product_session`(`session_id`,`data`,`expire`) values ('62f1204818f2976774225fb09d','{\"user_id\":\"1\",\"user_token\":\"2ALUG2BPfaANJX93UWpziBsJxZjbN3Op\",\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-03 14:43:05');
