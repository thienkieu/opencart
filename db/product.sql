...
/*Data for the table `product_address` */

/*Table structure for table `product_api` */

DROP TABLE IF EXISTS `product_api`;
...
/*Data for the table `product_api` */

insert  into `product_api`(`api_id`,`username`,`key`,`status`,`date_added`,`date_modified`) values (1,'Default','',1,'2018-12-03 21:09:47','2018-12-03 21:09:47');

/*Table structure for table `product_api_ip` */

DROP TABLE IF EXISTS `product_api_ip`;

CREATE TABLE `product_api_ip` (
...
/*Data for the table `product_api_ip` */

/*Table structure for table `product_api_session` */

DROP TABLE IF EXISTS `product_api_session`;

CREATE TABLE `product_api_session` (
...
/*Data for the table `product_api_session` */
...
insert  into `product_attribute`(`attribute_id`,`attribute_group_id`,`sort_order`) values (1,6,1),(2,6,5),(3,6,3),(4,3,1),(5,3,2),(6,3,3),(7,3,4),(8,3,5),(9,3,6),(10,3,7),(11,3,8);
...
/*Data for the table `product_attribute_description` */

insert  into `product_attribute_description`(`attribute_id`,`language_id`,`name`) values (1,1,'Description'),(2,1,'No. of Cores'),(4,1,'test 1'),(5,1,'test 2'),(6,1,'test 3'),(7,1,'test 4'),(8,1,'test 5'),(9,1,'test 6'),(10,1,'test 7'),(11,1,'test 8'),(3,1,'Clockspeed');
...
/*Data for the table `product_attribute_group` */

insert  into `product_attribute_group`(`attribute_group_id`,`sort_order`) values (3,2),(4,1),(5,3),(6,4);

/*Table structure for table `product_attribute_group_description` */

DROP TABLE IF EXISTS `product_attribute_group_description`;

CREATE TABLE `product_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
/*Data for the table `product_attribute_group_description` */

insert  into `product_attribute_group_description`(`attribute_group_id`,`language_id`,`name`) values (3,1,'Memory'),(4,1,'Technical'),(5,1,'Motherboard'),(6,1,'Processor');
...
/*Data for the table `product_banner` */

insert  into `product_banner`(`banner_id`,`name`,`status`) values (6,'HP Products',1),(7,'Home Page Slideshow',1),(8,'Manufacturers',1);

/*Table structure for table `product_banner_image` */
...
/*Data for the table `product_banner_image` */

insert  into `product_banner_image`(`banner_image_id`,`banner_id`,`language_id`,`title`,`link`,`image`,`sort_order`) values (79,7,1,'iPhone 6','index.php?route=product/product&amp;path=57&amp;product_id=49','catalog/demo/banners/iPhone6.jpg',0),(87,6,1,'HP Banner','index.php?route=product/manufacturer/info&amp;manufacturer_id=7','catalog/demo/compaq_presario.jpg',0),(94,8,1,'NFL','','catalog/demo/manufacturer/nfl.png',0),(95,8,1,'RedBull','','catalog/demo/manufacturer/redbull.png',0),(96,8,1,'Sony','','catalog/demo/manufacturer/sony.png',0),(91,8,1,'Coca Cola','','catalog/demo/manufacturer/cocacola.png',0),(92,8,1,'Burger King','','catalog/demo/manufacturer/burgerking.png',0),(93,8,1,'Canon','','catalog/demo/manufacturer/canon.png',0),(88,8,1,'Harley Davidson','','catalog/demo/manufacturer/harley.png',0),(89,8,1,'Dell','','catalog/demo/manufacturer/dell.png',0),(90,8,1,'Disney','','catalog/demo/manufacturer/disney.png',0),(80,7,1,'MacBookAir','','catalog/demo/banners/MacBookAir.jpg',0),(97,8,1,'Starbucks','','catalog/demo/manufacturer/starbucks.png',0),(98,8,1,'Nintendo','','catalog/demo/manufacturer/nintendo.png',0);
...
/*Data for the table `product_category_filter` */

/*Table structure for table `product_category_path` */

DROP TABLE IF EXISTS `product_category_path`;
...
/*Data for the table `product_category_to_layout` */

/*Table structure for table `product_category_to_store` */

DROP TABLE IF EXISTS `product_category_to_store`;
...
/*Data for the table `product_category_to_store` */

insert  into `product_category_to_store`(`category_id`,`store_id`) values (17,0),(18,0),(20,0),(24,0),(25,0),(26,0),(27,0),(28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(37,0),(38,0),(39,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0),(50,0),(51,0),(52,0),(53,0),(54,0),(55,0),(56,0),(57,0),(58,0);
...
/*Data for the table `product_coupon` */

insert  into `product_coupon`(`coupon_id`,`name`,`code`,`type`,`discount`,`logged`,`shipping`,`total`,`date_start`,`date_end`,`uses_total`,`uses_customer`,`status`,`date_added`) values (4,'-10% Discount','2222','P','10.0000',0,0,'0.0000','2014-01-01','2020-01-01',10,'10',0,'2009-01-27 13:55:03'),(5,'Free Shipping','3333','P','0.0000',0,1,'100.0000','2014-01-01','2014-02-01',10,'10',0,'2009-03-14 21:13:53'),(6,'-10.00 Discount','1111','F','10.0000',0,0,'10.0000','2014-01-01','2020-01-01',100000,'10000',0,'2009-03-14 21:15:18');

/*Table structure for table `product_coupon_category` */

DROP TABLE IF EXISTS `product_coupon_category`;

CREATE TABLE `product_coupon_category` (
  `coupon_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`coupon_id`,`category_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `product_coupon_category` */

/*Table structure for table `product_coupon_history` */

DROP TABLE IF EXISTS `product_coupon_history`;

CREATE TABLE `product_coupon_history` (
...
/*Data for the table `product_coupon_history` */

/*Table structure for table `product_coupon_product` */

DROP TABLE IF EXISTS `product_coupon_product`;

CREATE TABLE `product_coupon_product` (
...
/*Data for the table `product_coupon_product` */
...
/*Data for the table `product_currency` */

insert  into `product_currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values (1,'Pound Sterling','GBP','£','','2',0.61250001,1,'2014-09-25 14:40:00'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2019-02-13 13:06:29'),(3,'Euro','EUR','','€','2',0.78460002,1,'2014-09-25 14:40:00');

/*Table structure for table `product_custom_field` */
...
/*Data for the table `product_custom_field` */

/*Table structure for table `product_custom_field_customer_group` */

DROP TABLE IF EXISTS `product_custom_field_customer_group`;

CREATE TABLE `product_custom_field_customer_group` (
...
/*Data for the table `product_custom_field_customer_group` */

/*Table structure for table `product_custom_field_description` */

DROP TABLE IF EXISTS `product_custom_field_description`;

CREATE TABLE `product_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
/*Data for the table `product_custom_field_description` */

/*Table structure for table `product_custom_field_value` */

DROP TABLE IF EXISTS `product_custom_field_value`;
...
/*Data for the table `product_custom_field_value` */

/*Table structure for table `product_custom_field_value_description` */

DROP TABLE IF EXISTS `product_custom_field_value_description`;

CREATE TABLE `product_custom_field_value_description` (
...
/*Data for the table `product_custom_field_value_description` */
...
/*Data for the table `product_customer` */

/*Table structure for table `product_customer_activity` */

DROP TABLE IF EXISTS `product_customer_activity`;

CREATE TABLE `product_customer_activity` (
...
/*Data for the table `product_customer_activity` */

/*Table structure for table `product_customer_affiliate` */

DROP TABLE IF EXISTS `product_customer_affiliate`;

CREATE TABLE `product_customer_affiliate` (
  `customer_id` int(11) NOT NULL,
  `company` varchar(40) NOT NULL,
...
/*Data for the table `product_customer_affiliate` */

/*Table structure for table `product_customer_approval` */

DROP TABLE IF EXISTS `product_customer_approval`;

CREATE TABLE `product_customer_approval` (
...
/*Data for the table `product_customer_approval` */

/*Table structure for table `product_customer_group` */

DROP TABLE IF EXISTS `product_customer_group`;

CREATE TABLE `product_customer_group` (
...
/*Data for the table `product_customer_group` */

insert  into `product_customer_group`(`customer_group_id`,`approval`,`sort_order`) values (1,0,1);

/*Table structure for table `product_customer_group_description` */

DROP TABLE IF EXISTS `product_customer_group_description`;

CREATE TABLE `product_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
/*Data for the table `product_customer_group_description` */

insert  into `product_customer_group_description`(`customer_group_id`,`language_id`,`name`,`description`) values (1,1,'Default','test');

/*Table structure for table `product_customer_history` */

DROP TABLE IF EXISTS `product_customer_history`;

CREATE TABLE `product_customer_history` (
...
/*Data for the table `product_customer_history` */

/*Table structure for table `product_customer_ip` */

DROP TABLE IF EXISTS `product_customer_ip`;

CREATE TABLE `product_customer_ip` (
...
/*Data for the table `product_customer_ip` */

/*Table structure for table `product_customer_login` */

DROP TABLE IF EXISTS `product_customer_login`;

CREATE TABLE `product_customer_login` (
...
/*Data for the table `product_customer_login` */

/*Table structure for table `product_customer_online` */

DROP TABLE IF EXISTS `product_customer_online`;

CREATE TABLE `product_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
/*Data for the table `product_customer_online` */

/*Table structure for table `product_customer_reward` */

DROP TABLE IF EXISTS `product_customer_reward`;

CREATE TABLE `product_customer_reward` (
...
/*Data for the table `product_customer_reward` */

/*Table structure for table `product_customer_search` */

DROP TABLE IF EXISTS `product_customer_search`;

CREATE TABLE `product_customer_search` (
...
/*Data for the table `product_customer_search` */

/*Table structure for table `product_customer_transaction` */

DROP TABLE IF EXISTS `product_customer_transaction`;

CREATE TABLE `product_customer_transaction` (
...
/*Data for the table `product_customer_transaction` */

/*Table structure for table `product_customer_wishlist` */

DROP TABLE IF EXISTS `product_customer_wishlist`;

CREATE TABLE `product_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL,
...
/*Data for the table `product_customer_wishlist` */
...
/*Data for the table `product_download` */

/*Table structure for table `product_download_description` */

DROP TABLE IF EXISTS `product_download_description`;
...
/*Data for the table `product_download_description` */
...
/*Data for the table `product_extension_install` */

/*Table structure for table `product_extension_path` */

DROP TABLE IF EXISTS `product_extension_path`;

CREATE TABLE `product_extension_path` (
...
/*Data for the table `product_extension_path` */
...
/*Table structure for table `product_filter_description` */

DROP TABLE IF EXISTS `product_filter_description`;

CREATE TABLE `product_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
/*Data for the table `product_filter_description` */

/*Table structure for table `product_filter_group` */

DROP TABLE IF EXISTS `product_filter_group`;

CREATE TABLE `product_filter_group` (
  `filter_group_id` int(11) NOT NULL AUTO_INCREMENT,
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`filter_group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `product_filter_group` */

/*Table structure for table `product_filter_group_description` */

DROP TABLE IF EXISTS `product_filter_group_description`;

CREATE TABLE `product_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
/*Data for the table `product_filter_group_description` */

/*Table structure for table `product_geo_zone` */

DROP TABLE IF EXISTS `product_geo_zone`;

CREATE TABLE `product_geo_zone` (
...
/*Data for the table `product_geo_zone` */

insert  into `product_geo_zone`(`geo_zone_id`,`name`,`description`,`date_added`,`date_modified`) values (3,'UK VAT Zone','UK VAT','2009-01-06 23:26:25','2010-02-26 22:33:24'),(4,'UK Shipping','UK Shipping Zones','2009-06-23 01:14:53','2010-12-15 15:18:13');
...
insert  into `product_information`(`information_id`,`bottom`,`sort_order`,`status`) values (3,1,3,1),(4,1,1,1),(5,1,4,1),(6,1,2,1);

/*Table structure for table `product_information_description` */

DROP TABLE IF EXISTS `product_information_description`;

CREATE TABLE `product_information_description` (
...
/*Data for the table `product_information_description` */

insert  into `product_information_description`(`information_id`,`language_id`,`title`,`description`,`meta_title`,`meta_description`,`meta_keyword`) values (4,1,'About Us','&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n','About Us','',''),(5,1,'Terms &amp; Conditions','&lt;p&gt;\r\n	Terms &amp;amp; Conditions&lt;/p&gt;\r\n','Terms &amp; Conditions','',''),(3,1,'Privacy Policy','&lt;p&gt;\r\n	Privacy Policy&lt;/p&gt;\r\n','Privacy Policy','',''),(6,1,'Delivery Information','&lt;p&gt;\r\n	Delivery Information&lt;/p&gt;\r\n','Delivery Information','','');

/*Table structure for table `product_information_to_layout` */

DROP TABLE IF EXISTS `product_information_to_layout`;

CREATE TABLE `product_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
/*Data for the table `product_information_to_layout` */

/*Table structure for table `product_information_to_store` */

DROP TABLE IF EXISTS `product_information_to_store`;

CREATE TABLE `product_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `product_information_to_store` */

insert  into `product_information_to_store`(`information_id`,`store_id`) values (3,0),(4,0),(5,0),(6,0);
...
insert  into `product_language`(`language_id`,`name`,`code`,`locale`,`image`,`directory`,`sort_order`,`status`) values (1,'English','en-gb','en-US,en_US.UTF-8,en_US,en-gb,english','gb.png','english',1,1);

/*Table structure for table `product_layout` */

DROP TABLE IF EXISTS `product_layout`;
...
/*Data for the table `product_layout` */

insert  into `product_layout`(`layout_id`,`name`) values (1,'Home'),(2,'Product'),(3,'Category'),(4,'Default'),(5,'Manufacturer'),(6,'Account'),(7,'Checkout'),(8,'Contact'),(9,'Sitemap'),(10,'Affiliate'),(11,'Information'),(12,'Compare'),(13,'Search'),(14,'Test layout');

/*Table structure for table `product_layout_module` */

DROP TABLE IF EXISTS `product_layout_module`;

CREATE TABLE `product_layout_module` (
...
/*Data for the table `product_layout_module` */

insert  into `product_layout_module`(`layout_module_id`,`layout_id`,`code`,`position`,`sort_order`) values (2,4,'0','content_top',0),(3,4,'0','content_top',1),(20,5,'0','column_left',2),(69,10,'account','column_right',1),(68,6,'account','column_right',1),(67,1,'carousel.29','content_top',3),(66,1,'slideshow.27','content_top',1),(65,1,'featured.28','content_top',2),(72,3,'category','column_left',1),(73,3,'banner.30','column_left',2),(79,14,'featured.28','content_top',1),(78,14,'slideshow.27','content_top',0);

/*Table structure for table `product_layout_route` */

DROP TABLE IF EXISTS `product_layout_route`;

CREATE TABLE `product_layout_route` (
...
/*Data for the table `product_layout_route` */

insert  into `product_layout_route`(`layout_route_id`,`layout_id`,`store_id`,`route`) values (38,6,0,'account/%'),(17,10,0,'affiliate/%'),(44,3,0,'product/category'),(42,1,0,'common/home'),(20,2,0,'product/product'),(24,11,0,'information/information'),(23,7,0,'checkout/%'),(31,8,0,'information/contact'),(32,9,0,'information/sitemap'),(34,4,0,''),(45,5,0,'product/manufacturer'),(52,12,0,'product/compare'),(53,13,0,'product/search'),(56,14,0,'test2');

/*Table structure for table `product_length_class` */

DROP TABLE IF EXISTS `product_length_class`;

CREATE TABLE `product_length_class` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL,
  PRIMARY KEY (`length_class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

/*Data for the table `product_length_class` */

insert  into `product_length_class`(`length_class_id`,`value`) values (1,'1.00000000'),(2,'10.00000000'),(3,'0.39370000');

/*Table structure for table `product_length_class_description` */

DROP TABLE IF EXISTS `product_length_class_description`;

CREATE TABLE `product_length_class_description` (
...
/*Data for the table `product_length_class_description` */

insert  into `product_length_class_description`(`length_class_id`,`language_id`,`title`,`unit`) values (1,1,'Centimeter','cm'),(2,1,'Millimeter','mm'),(3,1,'Inch','in');
...
/*Data for the table `product_location` */
...
insert  into `product_manufacturer`(`manufacturer_id`,`name`,`image`,`sort_order`) values (5,'HTC','catalog/demo/htc_logo.jpg',0),(6,'Palm','catalog/demo/palm_logo.jpg',0),(7,'Hewlett-Packard','catalog/demo/hp_logo.jpg',0),(8,'Apple','catalog/demo/apple_logo.jpg',0),(9,'Canon','catalog/demo/canon_logo.jpg',0),(10,'Sony','catalog/demo/sony_logo.jpg',0);

/*Table structure for table `product_manufacturer_to_store` */

DROP TABLE IF EXISTS `product_manufacturer_to_store`;

CREATE TABLE `product_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`manufacturer_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `product_manufacturer_to_store` */

insert  into `product_manufacturer_to_store`(`manufacturer_id`,`store_id`) values (5,0),(6,0),(7,0),(8,0),(9,0),(10,0);
...
/*Data for the table `product_marketing` */

/*Table structure for table `product_modification` */

DROP TABLE IF EXISTS `product_modification`;
...
/*Data for the table `product_modification` */
...
/*Data for the table `product_module` */

insert  into `product_module`(`module_id`,`name`,`code`,`setting`) values (30,'Category','banner','{\"name\":\"Category\",\"banner_id\":\"6\",\"width\":\"182\",\"height\":\"182\",\"status\":\"1\"}'),(29,'Home Page','carousel','{\"name\":\"Home Page\",\"banner_id\":\"8\",\"width\":\"130\",\"height\":\"100\",\"status\":\"1\"}'),(28,'Home Page','featured','{\"name\":\"Home Page\",\"product\":[\"43\",\"40\",\"42\",\"30\"],\"limit\":\"4\",\"width\":\"200\",\"height\":\"200\",\"status\":\"1\"}'),(27,'Home Page','slideshow','{\"name\":\"Home Page\",\"banner_id\":\"7\",\"width\":\"1140\",\"height\":\"380\",\"status\":\"1\"}'),(31,'Banner 1','banner','{\"name\":\"Banner 1\",\"banner_id\":\"6\",\"width\":\"182\",\"height\":\"182\",\"status\":\"1\"}'),(32,'megamenu1','megamenu','{\"name\":\"megamenu1\",\"width\":\"4\",\"height\":\"4\",\"status\":\"1\"}'),(33,'megamenu2','megamenu','{\"name\":\"megamenu2\",\"width\":\"3\",\"height\":\"4\",\"status\":\"1\"}'),(44,'test','megamenu_column','{\"name\":\"test\",\"tree\":\"\"}'),(43,'Speakers &amp; Phone','megamenu_column','{\"name\":\"Speakers &amp; Phone\",\"link\":\"\",\"icon\":\"catalog\\/profile-pic.png\",\"type\":\"type_slide\",\"category\":\"\",\"status\":\"1\"}'),(40,'All Category','megamenu_column','{\"name\":\"All Category\",\"link\":\"\",\"icon\":\"catalog\\/profile-pic.png\",\"type\":\"type_column\",\"category\":\"\",\"product_category\":[\"41\",\"42\",\"43\"],\"status\":\"1\"}'),(41,'Electronics','megamenu_column','{\"name\":\"Electronics\",\"link\":\"\",\"icon\":\"catalog\\/profile-pic.png\",\"type\":\"type_column\",\"category\":\"\",\"status\":\"1\"}'),(42,'Fashion &amp; Cloths','megamenu_column','{\"name\":\"Fashion &amp; Cloths\",\"link\":\"\",\"icon\":\"catalog\\/profile-pic.png\",\"type\":\"type_column\",\"category\":\"\",\"status\":\"1\"}'),(45,'Megamenu','megamenu_column','{\"name\":\"Megamenu\",\"tree\":\"\"}');
...
insert  into `product_option`(`option_id`,`type`,`sort_order`) values (1,'radio',1),(2,'checkbox',2),(4,'text',3),(5,'select',4),(6,'textarea',5),(7,'file',6),(8,'date',7),(9,'time',8),(10,'datetime',9),(11,'select',10),(12,'date',11);
...
/*Data for the table `product_option_description` */

insert  into `product_option_description`(`option_id`,`language_id`,`name`) values (1,1,'Radio'),(2,1,'Checkbox'),(4,1,'Text'),(6,1,'Textarea'),(8,1,'Date'),(7,1,'File'),(5,1,'Select'),(9,1,'Time'),(10,1,'Date &amp; Time'),(12,1,'Delivery Date'),(11,1,'Size');
...
insert  into `product_option_value`(`option_value_id`,`option_id`,`image`,`sort_order`) values (43,1,'',3),(32,1,'',1),(45,2,'',4),(44,2,'',3),(42,5,'',4),(41,5,'',3),(39,5,'',1),(40,5,'',2),(31,1,'',2),(23,2,'',1),(24,2,'',2),(46,11,'',1),(47,11,'',2),(48,11,'',3);
...
/*Data for the table `product_option_value_description` */

insert  into `product_option_value_description`(`option_value_id`,`language_id`,`option_id`,`name`) values (43,1,1,'Large'),(32,1,1,'Small'),(45,1,2,'Checkbox 4'),(44,1,2,'Checkbox 3'),(31,1,1,'Medium'),(42,1,5,'Yellow'),(41,1,5,'Green'),(39,1,5,'Red'),(40,1,5,'Blue'),(23,1,2,'Checkbox 1'),(24,1,2,'Checkbox 2'),(48,1,11,'Large'),(47,1,11,'Medium'),(46,1,11,'Small');
...
/*Data for the table `product_order_history` */

/*Table structure for table `product_order_option` */

DROP TABLE IF EXISTS `product_order_option`;

CREATE TABLE `product_order_option` (
...
/*Data for the table `product_order_option` */

/*Table structure for table `product_order_product` */

DROP TABLE IF EXISTS `product_order_product`;
...
/*Data for the table `product_order_product` */

/*Table structure for table `product_order_recurring` */

DROP TABLE IF EXISTS `product_order_recurring`;

CREATE TABLE `product_order_recurring` (
...
/*Data for the table `product_order_recurring` */

/*Table structure for table `product_order_recurring_transaction` */

DROP TABLE IF EXISTS `product_order_recurring_transaction`;

CREATE TABLE `product_order_recurring_transaction` (
...
/*Data for the table `product_order_recurring_transaction` */

/*Table structure for table `product_order_shipment` */

DROP TABLE IF EXISTS `product_order_shipment`;
...
/*Data for the table `product_order_shipment` */
...
/*Data for the table `product_order_status` */

insert  into `product_order_status`(`order_status_id`,`language_id`,`name`) values (2,1,'Processing'),(3,1,'Shipped'),(7,1,'Canceled'),(5,1,'Complete'),(8,1,'Denied'),(9,1,'Canceled Reversal'),(10,1,'Failed'),(11,1,'Refunded'),(12,1,'Reversed'),(13,1,'Chargeback'),(1,1,'Pending'),(16,1,'Voided'),(15,1,'Processed'),(14,1,'Expired');

/*Table structure for table `product_order_total` */

DROP TABLE IF EXISTS `product_order_total`;

CREATE TABLE `product_order_total` (
...
/*Data for the table `product_order_total` */

/*Table structure for table `product_order_voucher` */

DROP TABLE IF EXISTS `product_order_voucher`;

CREATE TABLE `product_order_voucher` (
...
/*Data for the table `product_order_voucher` */
...
/*Data for the table `product_product_attribute` */

insert  into `product_product_attribute`(`product_id`,`attribute_id`,`language_id`,`text`) values (43,2,1,'1'),(47,4,1,'16GB'),(43,4,1,'8gb'),(42,3,1,'100mhz'),(47,2,1,'4');

/*Table structure for table `product_product_description` */

DROP TABLE IF EXISTS `product_product_description`;
...
/*Data for the table `product_product_discount` */

insert  into `product_product_discount`(`product_discount_id`,`product_id`,`customer_group_id`,`quantity`,`priority`,`price`,`date_start`,`date_end`) values (440,42,1,30,1,'66.0000','0000-00-00','0000-00-00'),(439,42,1,20,1,'77.0000','0000-00-00','0000-00-00'),(438,42,1,10,1,'88.0000','0000-00-00','0000-00-00');

/*Table structure for table `product_product_filter` */

DROP TABLE IF EXISTS `product_product_filter`;

CREATE TABLE `product_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`filter_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `product_product_filter` */
...
/*Data for the table `product_product_option` */

insert  into `product_product_option`(`product_option_id`,`product_id`,`option_id`,`value`,`required`) values (224,35,11,'',1),(225,47,12,'2011-04-22',1),(223,42,2,'',1),(217,42,5,'',1),(209,42,6,'',1),(218,42,1,'',1),(208,42,4,'test',1),(219,42,8,'2011-02-20',1),(222,42,7,'',1),(221,42,9,'22:25',1),(220,42,10,'2011-02-20 22:25',1),(226,30,5,'',1);
...
/*Data for the table `product_product_option_value` */
...
/*Table structure for table `product_product_recurring` */

DROP TABLE IF EXISTS `product_product_recurring`;

CREATE TABLE `product_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
/*Data for the table `product_product_recurring` */

/*Table structure for table `product_product_related` */

DROP TABLE IF EXISTS `product_product_related`;

CREATE TABLE `product_product_related` (
  `product_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`related_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `product_product_related` */

insert  into `product_product_related`(`product_id`,`related_id`) values (40,42),(41,42),(42,40),(42,41);

/*Table structure for table `product_product_reward` */

DROP TABLE IF EXISTS `product_product_reward`;

CREATE TABLE `product_product_reward` (
...
/*Data for the table `product_product_reward` */

insert  into `product_product_reward`(`product_reward_id`,`product_id`,`customer_group_id`,`points`) values (515,42,1,100),(519,47,1,300),(379,28,1,400),(329,43,1,600),(339,29,1,0),(343,48,1,0),(335,40,1,0),(539,30,1,200),(331,44,1,700),(333,45,1,800),(337,31,1,0),(425,35,1,0),(345,33,1,0),(347,46,1,0),(545,41,1,0),(351,36,1,0),(353,34,1,0),(355,32,1,0),(521,49,1,1000);

/*Table structure for table `product_product_special` */

DROP TABLE IF EXISTS `product_product_special`;

CREATE TABLE `product_product_special` (
...
/*Data for the table `product_product_special` */

insert  into `product_product_special`(`product_special_id`,`product_id`,`customer_group_id`,`priority`,`price`,`date_start`,`date_end`) values (419,42,1,1,'90.0000','0000-00-00','0000-00-00'),(439,30,1,2,'90.0000','0000-00-00','0000-00-00'),(438,30,1,1,'80.0000','0000-00-00','0000-00-00');

/*Table structure for table `product_product_to_category` */

DROP TABLE IF EXISTS `product_product_to_category`;

CREATE TABLE `product_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
/*Data for the table `product_product_to_category` */

insert  into `product_product_to_category`(`product_id`,`category_id`) values (28,20),(28,24),(29,20),(29,24),(30,20),(30,33),(31,33),(32,34),(33,20),(33,28),(34,34),(35,20),(36,34),(40,20),(40,24),(41,27),(42,20),(42,28),(43,18),(43,20),(44,18),(44,20),(45,18),(46,18),(46,20),(47,18),(47,20),(48,20),(48,34),(49,57);

/*Table structure for table `product_product_to_download` */

DROP TABLE IF EXISTS `product_product_to_download`;

CREATE TABLE `product_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`download_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `product_product_to_download` */

/*Table structure for table `product_product_to_layout` */

DROP TABLE IF EXISTS `product_product_to_layout`;

CREATE TABLE `product_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
/*Data for the table `product_product_to_layout` */

/*Table structure for table `product_product_to_store` */

DROP TABLE IF EXISTS `product_product_to_store`;

CREATE TABLE `product_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `product_product_to_store` */

insert  into `product_product_to_store`(`product_id`,`store_id`) values (28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0);
...
/*Table structure for table `product_recurring_description` */

DROP TABLE IF EXISTS `product_recurring_description`;

CREATE TABLE `product_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
/*Data for the table `product_recurring_description` */
...
/*Data for the table `product_return` */

/*Table structure for table `product_return_action` */

DROP TABLE IF EXISTS `product_return_action`;

CREATE TABLE `product_return_action` (
...
/*Data for the table `product_return_action` */

insert  into `product_return_action`(`return_action_id`,`language_id`,`name`) values (1,1,'Refunded'),(2,1,'Credit Issued'),(3,1,'Replacement Sent');

/*Table structure for table `product_return_history` */

DROP TABLE IF EXISTS `product_return_history`;
...
/*Data for the table `product_return_history` */

/*Table structure for table `product_return_reason` */

DROP TABLE IF EXISTS `product_return_reason`;

CREATE TABLE `product_return_reason` (
...
/*Data for the table `product_return_reason` */

insert  into `product_return_reason`(`return_reason_id`,`language_id`,`name`) values (1,1,'Dead On Arrival'),(2,1,'Received Wrong Item'),(3,1,'Order Error'),(4,1,'Faulty, please supply details'),(5,1,'Other, please supply details');

/*Table structure for table `product_return_status` */

DROP TABLE IF EXISTS `product_return_status`;

CREATE TABLE `product_return_status` (
...
/*Data for the table `product_return_status` */

insert  into `product_return_status`(`return_status_id`,`language_id`,`name`) values (1,1,'Pending'),(3,1,'Complete'),(2,1,'Awaiting Products');
...
/*Table structure for table `product_seo_url` */

DROP TABLE IF EXISTS `product_seo_url`;

CREATE TABLE `product_seo_url` (
...
/*Data for the table `product_session` */

insert  into `product_session`(`session_id`,`data`,`expire`) values ('04572daad29e09c3898e958b1e','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-16 15:59:43'),('0acd9828b5f68b7acd370e9773','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"jXCP6BVmPtY0kFLzN3gIchDyAMCR9vtQ\"}','2018-12-29 06:51:30'),('103f944a30f926d5d6cccd76ca','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"zobU8i4yGsdCQ6GUaBRikj1JCsJOiD1T\"}','2018-12-07 16:47:26'),('1a5174b0daff0a1588fca9f253','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-08 10:16:03'),('1ade2296c0e61201e6cbbe2645','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"wYUmufb00DAID3clZKi1r8tgXrV5iPRv\"}','2018-12-11 16:46:00'),('1ec83632fe9a44a1a07fe77415','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-22 16:16:27'),('1f9569c85857f8f5e8dca7eca2','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"IwPOHjYGHFcO3loPGBlSPFRlvqxAI9tu\"}','2019-01-31 15:11:36'),('1fdd674412a99d16f4ffe71103','{\"user_id\":\"1\",\"user_token\":\"xpqCpsUjCb4vZYD2dzGwFf8yj9oVNcHt\",\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-30 15:50:25'),('229ab8c6695ae23a704a2dcd70','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-28 12:22:46'),('32776f7a7087b393d1d5b26657','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-14 01:02:20'),('3c4ba14990e2758b7a56fe4252','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"XcsoKZdpzsIM5CV6dWVgaDr4I6uOCvNs\"}','2018-12-23 08:27:45'),('3e88b49e4957de00061d4cbd7c','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-30 08:05:57'),('44fd244c1481fb10112bdb6285','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-22 16:16:39'),('4cb86a9509afee46c50e1e6474','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"4ypDNeVZHvrk7KnEVqNRRY6dF4cjJ4gz\"}','2018-12-05 16:38:29'),('58b6dc7ee3281a4feb664721e3','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-09 15:29:27'),('59baac6fd13dc86841ea7c1cd3','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"ReaLwbH41QoTxrYf0G6OknMZQR90MCpx\"}','2018-12-31 15:34:41'),('60265ad0d146dcac863bcad35c','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-02-07 04:01:17'),('62f1204818f2976774225fb09d','{\"user_id\":\"1\",\"user_token\":\"2ALUG2BPfaANJX93UWpziBsJxZjbN3Op\",\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-03 14:43:05'),('69a468446a0245addc8889e670','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-01 15:04:21'),('6e494eede0a56f7fa03389d820','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-02-07 04:01:17'),('7263d0cf703958ce62f8bbd134','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"bGjkwlQRGTGoFHBapTifvh6n0ryXH636\"}','2018-12-12 16:23:10'),('7334eb5d3209caeff221d56c4c','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-15 08:24:53'),('7499969f8eea1117ba739b1cc3','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-13 15:56:26'),('79a9755b3b483ed25ce4c5e3e5','{\"user_id\":\"1\",\"user_token\":\"ZffTQTWKaPG3KULIJWgu6XyltoEauM9v\",\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-01 15:44:44'),('7f85f2b264bfd77b68889c30ea','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-11 14:21:59'),('805189d54b4b4e8aa4d263c8ed','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"PY3Ed92aq2B3uMxzFM8WKwh4xij94dLL\"}','2019-02-13 16:42:46'),('8ce956bf79fa96db4959ce1da0','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"Jmq3KpVi8I88AD47pyjZC5t2ZupAN5PI\"}','2019-01-06 15:36:58'),('8e8b065c6dfeaf3255e6d660b3','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-08 02:52:12'),('8e8bd3c0ebfc60779c9e55d36b','{\"user_id\":\"1\",\"user_token\":\"0ZDg0vNGCge8BHPuw43dXcYwHudMsHvl\"}','2018-12-15 08:47:10'),('905e10822897f9223e3690fbfd','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-23 14:53:45'),('9087e4651914294930f44ce7b6','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-17 15:52:59'),('984c637c984b343adf49461d13','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"a5LWQTgOZlV63TgsQ67bAa2aAx1afDDD\"}','2019-01-21 16:08:35'),('a31114caf03dfb14968be9ba3e','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"FnNlnLa6oFhlRgOgKvxNkjWZCNnlFFrk\"}','2019-01-29 17:16:31'),('af77fdf9391ae637e3189be355','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-07 14:59:28'),('afe244ea7fb76b91381242f6de','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-17 14:31:58'),('b3afb22ed8ce919dbbb8f3060f','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"RPoLMrBbYGxi4XDcfOBEJBs8GRc8E5Ii\"}','2019-02-11 16:17:40'),('c429802c74f9498c288fdf3b64','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"tdib3i4nlyRIQJAQ9OI5AM4rBJcXt2uh\"}','2018-12-27 16:42:07'),('c823a481c345efe80315215d9d','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-06 03:47:33'),('c87612aa103c053748b771253f','{\"user_id\":\"1\",\"user_token\":\"WVrwX22OK9HpQ1ng8GACOHpYpKBXwBgZ\",\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-17 16:16:39'),('d10d6ba2c33bf360390db5d471','false','2018-12-17 14:31:49'),('d645e962fb346cacc4d534587e','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-14 01:03:43'),('dda07c30b0600ac64a82cfbedc','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"QqfWpVCUVQLJsajVypg7fTA6mzq2QU2Z\"}','2018-12-14 16:45:37'),('e3ed2da7c8155c489b8a2c8df7','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-29 15:47:57'),('e4b9863187e7fe8a425546f73c','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-15 08:24:57'),('e8f726b94e23d95289b5e093f8','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-02-13 13:27:10'),('f205379da59d111b155c180f43','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-01-27 16:13:36'),('f7a1d010482e9b6d0f4c9305a2','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2019-02-11 11:02:56'),('f7f917b01f2fbfce4e6dc4f25f','{\"user_id\":\"1\",\"user_token\":\"GoG2eKVaZ3UFkoy0scBq90qPtPX8KeN3\"}','2018-12-24 16:47:12'),('f8917e3d42096da9054ad705b4','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"hSKnUKxBYry9wmQDDLjhpkfTPxptWDlE\"}','2019-01-28 16:48:30'),('f901b6ba0798faa02cbb1b83b1','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"hEfI5j8yihMLRYyDThNXFPrfCpxGBcrj\"}','2019-01-20 17:07:38'),('fb5d9797e94732c1214ff21c07','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-12 15:41:21'),('fddbdf60cd64ab67445c50fac0','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-17 14:31:54'),('ff8d7e546d4a75a60541346088','{\"language\":\"en-gb\",\"currency\":\"USD\"}','2018-12-08 09:19:43');
...
/*Data for the table `product_shipping_courier` */

insert  into `product_shipping_courier`(`shipping_courier_id`,`shipping_courier_code`,`shipping_courier_name`) values (1,'dhl','DHL'),(2,'fedex','Fedex'),(3,'ups','UPS'),(4,'royal-mail','Royal Mail'),(5,'usps','United States Postal Service'),(6,'auspost','Australia Post'),(7,'citylink','Citylink');
...
/*Data for the table `product_statistics` */

insert  into `product_statistics`(`statistics_id`,`code`,`value`) values (1,'order_sale','0.0000'),(2,'order_processing','0.0000'),(3,'order_complete','0.0000'),(4,'order_other','0.0000'),(5,'returns','0.0000'),(6,'product','0.0000'),(7,'review','0.0000');
...
/*Data for the table `product_stock_status` */

insert  into `product_stock_status`(`stock_status_id`,`language_id`,`name`) values (7,1,'In Stock'),(8,1,'Pre-Order'),(5,1,'Out Of Stock'),(6,1,'2-3 Days');
...
/*Table structure for table `product_tax_class` */

DROP TABLE IF EXISTS `product_tax_class`;
...
/*Data for the table `product_tax_class` */

insert  into `product_tax_class`(`tax_class_id`,`title`,`description`,`date_added`,`date_modified`) values (9,'Taxable Goods','Taxed goods','2009-01-06 23:21:53','2011-09-23 14:07:50'),(10,'Downloadable Products','Downloadable','2011-09-21 22:19:39','2011-09-22 10:27:36');
...
/*Data for the table `product_tax_rate` */

insert  into `product_tax_rate`(`tax_rate_id`,`geo_zone_id`,`name`,`rate`,`type`,`date_added`,`date_modified`) values (86,3,'VAT (20%)','20.0000','P','2011-03-09 21:17:10','2011-09-22 22:24:29'),(87,3,'Eco Tax (-2.00)','2.0000','F','2011-09-21 21:49:23','2011-09-23 00:40:19');

/*Table structure for table `product_tax_rate_to_customer_group` */

DROP TABLE IF EXISTS `product_tax_rate_to_customer_group`;

CREATE TABLE `product_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
  PRIMARY KEY (`tax_rate_id`,`customer_group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `product_tax_rate_to_customer_group` */

insert  into `product_tax_rate_to_customer_group`(`tax_rate_id`,`customer_group_id`) values (86,1),(87,1);

/*Table structure for table `product_tax_rule` */

DROP TABLE IF EXISTS `product_tax_rule`;

CREATE TABLE `product_tax_rule` (
...
/*Data for the table `product_tax_rule` */

insert  into `product_tax_rule`(`tax_rule_id`,`tax_class_id`,`tax_rate_id`,`based`,`priority`) values (121,10,86,'payment',1),(120,10,87,'store',0),(128,9,86,'shipping',1),(127,9,87,'shipping',2);
...
/*Data for the table `product_theme` */
...
insert  into `product_user`(`user_id`,`user_group_id`,`username`,`password`,`salt`,`firstname`,`lastname`,`email`,`image`,`code`,`ip`,`status`,`date_added`) values (1,1,'admin','419fff05cdedc980aed577e7c564a05623592c50','ygeqOgSab','John','Doe','thien1988@gmail.com','','','127.0.0.1',1,'2018-12-03 21:09:47');

/*Table structure for table `product_user_group` */

DROP TABLE IF EXISTS `product_user_group`;
...
/*Data for the table `product_voucher` */

/*Table structure for table `product_voucher_history` */

DROP TABLE IF EXISTS `product_voucher_history`;

CREATE TABLE `product_voucher_history` (
...
/*Data for the table `product_voucher_history` */

/*Table structure for table `product_voucher_theme` */

DROP TABLE IF EXISTS `product_voucher_theme`;

CREATE TABLE `product_voucher_theme` (
  `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) NOT NULL,
  PRIMARY KEY (`voucher_theme_id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

/*Data for the table `product_voucher_theme` */

insert  into `product_voucher_theme`(`voucher_theme_id`,`image`) values (8,'catalog/demo/canon_eos_5d_2.jpg'),(7,'catalog/demo/gift-voucher-birthday.jpg'),(6,'catalog/demo/apple_logo.jpg');

/*Table structure for table `product_voucher_theme_description` */

DROP TABLE IF EXISTS `product_voucher_theme_description`;

CREATE TABLE `product_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
/*Data for the table `product_voucher_theme_description` */

insert  into `product_voucher_theme_description`(`voucher_theme_id`,`language_id`,`name`) values (6,1,'Christmas'),(7,1,'Birthday'),(8,1,'General');

/*Table structure for table `product_weight_class` */

DROP TABLE IF EXISTS `product_weight_class`;

CREATE TABLE `product_weight_class` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000',
  PRIMARY KEY (`weight_class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `product_weight_class` */

insert  into `product_weight_class`(`weight_class_id`,`value`) values (1,'1.00000000'),(2,'1000.00000000'),(5,'2.20460000'),(6,'35.27400000');

/*Table structure for table `product_weight_class_description` */

DROP TABLE IF EXISTS `product_weight_class_description`;

CREATE TABLE `product_weight_class_description` (
...
/*Data for the table `product_weight_class_description` */

insert  into `product_weight_class_description`(`weight_class_id`,`language_id`,`title`,`unit`) values (1,1,'Kilogram','kg'),(2,1,'Gram','g'),(5,1,'Pound ','lb'),(6,1,'Ounce','oz');
